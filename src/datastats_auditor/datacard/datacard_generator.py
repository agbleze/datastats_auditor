...
import base64
from datastats_auditor.datacard.card_sections import (create_section, 
...
from datastats_auditor.datacard.utils import (compute_summary_stats_wider, 
                                              concat_split_dfs,
                                              write_md_to_pdf,
...
if __name__ == "__main__":
    ...
    generate_dataset_card_with_multiple_plots(splits, pdf_path="multiplot_card.pdf")
