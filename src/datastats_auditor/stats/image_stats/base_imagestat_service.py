...
class BaseImageStatsService(ABC):
    name: str = "base_imagestat_service"
    ...
    def __init_subclass__(cls):
        ...
        for attr in cls.required:
            if attr not in cls.__dict__:
                raise NotImplementedError(f"{cls.__name__} requires definining a '{attr}' class attribute because it is a Subclass of BaseImageStatsService.")
